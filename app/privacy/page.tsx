...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-[#EFE3CA] py-12 px-6">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold text-[#170C79]">Privacy Policy</h1>
        <p className="text-[#8ACBD0] mt-1 mb-10">Last updated: May 2025</p>

        <Card className="mb-6 p-6">
          <h2 className="text-2xl font-bold text-[#170C79] mb-4">Data We Collect</h2>
          <p className="text-[#8ACBD0] leading-relaxed">
        ...
        <Card className="mb-6 p-6">
          <h2 className="text-2xl font-bold text-[#170C79] mb-4">How Audio Is Processed</h2>
          <p className="text-[#8ACBD0] leading-relaxed">
        ...
        <Card className="mb-6 p-6">
          <h2 className="text-2xl font-bold text-[#170C79] mb-4">Facial Data</h2>
          <p className="text-[#8ACBD0] leading-relaxed">
        ...
        <Card className="mb-6 p-6">
          <h2 className="text-2xl font-bold text-[#170C79] mb-4">Third-Party Processors</h2>
          <ul className="list-disc pl-5 space-y-2 text-[#8ACBD0]">
            <li>
              <strong>AssemblyAI</strong> — audio transcription. Privacy policy:{' '}
              <a href="https://assemblyai.com/privacy" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#170C79] transition-colors">
                assemblyai.com/privacy
              </a>
            </li>
            <li>
              <strong>Supabase</strong> — database and authentication. Privacy policy:{' '}
              <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#170C79] transition-colors">
                supabase.com/privacy
              </a>
            </li>
            <li>
              <strong>Vercel</strong> — hosting. Privacy policy:{' '}
              <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#170C79] transition-colors">
        ...
        <Card className="mb-6 p-6">
          <h2 className="text-2xl font-bold text-[#170C79] mb-4">Data Retention</h2>
          <p className="text-[#8ACBD0] leading-relaxed">
        ...
        <Card className="mb-6 p-6">
          <h2 className="text-2xl font-bold text-[#170C79] mb-4">Contact</h2>
          <p className="text-[#8ACBD0] leading-relaxed">
            For privacy-related questions or data deletion requests, please contact us at{' '}
            <a href="mailto:privacy@intervise.in" className="underline hover:text-[#170C79] transition-colors">

...
export function ChartsClient({
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-[10px] font-semibold uppercase tracking-widest text-white/70">Your Scores</p>
      ...
      <p className="text-[10px] font-semibold uppercase tracking-widest text-white/70">Your Delivery</p>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">

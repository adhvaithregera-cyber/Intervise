  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
      <div className="mb-8 text-center">
        ...
        <p className="mt-4 text-2xl font-bold text-slate-900">Create your account</p>
        <p className="mt-1 text-sm text-slate-500">Start practising interviews for free</p>
      </div>

...
export function InterviewComparison() {
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
      ...
      {/* ── Before ── */}
      <div className="flex flex-col rounded-2xl border border-[#ADBBDA] bg-white overflow-hidden">
        {/* Header */}
      ...
      {/* ── After ── */}
      <div className="flex flex-col rounded-2xl border border-[#7091E6]/40 overflow-hidden" style={{ backgroundColor: '#3D52A0' }}>
        {/* Header */}
        <div className="flex items-center justify-between border-b border-[#7091E6]/30 px-6 py-4" style={{ backgroundColor: 'rgba(112,145,230,0.15)' }}>
          <div>
            <p className="text-[10px] font-bold uppercase tracking-widest text-[#7091E6]">After</p>
            <p className="mt-0.5 text-sm font-semibold text-white">STAR format applied</p>
          </div>
          <div className="flex items-center gap-3">
            <span className="rounded-full border border-[#7091E6]/50 bg-[#7091E6]/20 px-3 py-0.5 text-xs font-semibold text-[#7091E6]">
              STAR
            </span>
            <span className="flex h-11 w-11 items-center justify-center rounded-full bg-[#7091E6]/30 text-xl font-black text-white">
              A
            </span>
          </div>
        </div>
        ...
        {/* Answer */}
        <div className="px-6 py-5">
          <blockquote className="rounded-xl border border-[#7091E6]/30 bg-white/10 p-4 text-sm leading-relaxed text-white/90">
            <span className="mb-1 block text-[10px] font-bold uppercase tracking-widest text-[#7091E6]">
              S — Situation (Present)
            </span>
            ...
            <span className="mt-3 mb-1 block text-[10px] font-bold uppercase tracking-widest text-[#7091E6]">
              T — Task (Past)
            </span>
        ...
        {/* Strengths */}
        <div className="mt-auto border-t border-[#7091E6]/30 px-6 py-5">
          <ul className="space-y-2.5">
            {afterStrengths.map((s) => (
              <li key={s} className="flex items-start gap-2.5 text-sm text-white/80">
                <span className="mt-0.5 shrink-0 text-[#7091E6]">✓</span>
                {s}
              </li>
            ))}
          </ul>
